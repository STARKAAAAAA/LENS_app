...
| 版本 | 更新 |
|------|------|
| v1.6.0 | 自定义标题栏（融合式按钮）、快捷键提示/排序筛选高斯模糊开关动画、画廊导航栏 sticky 毛玻璃、侧边栏折叠高斯模糊、灯箱 z-index 修正、EXIF 尺寸标签读取优化、CSS/JS 全面模块化拆分（12+10 文件）、Rust 端错误日志、代理绕过黑屏修复、功能开关即时响应 |
